...
inputs = {
  ...
  aws_subnet_cidr_block = cidrsubnet(dependency.vpc.outputs.aws_vpc_cidr_block, 4, 2)
  aws_subnet_ipv6_cidr_block = cidrsubnet(dependency.vpc.outputs.aws_vpc_ipv6_cidr_block, 8, 2)
