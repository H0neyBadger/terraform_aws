...
inputs = {
  ...
  aws_security_group_ingress = [
    ...
    {
      description = "allow ipv4 https"
      port        = 443
      protocol    = "tcp"
      cidr_blocks = ["0.0.0.0/0"]
    },
    {
      description = "allow ipv6 alt http"
      port        = 8080
      protocol    = "tcp"
      ipv6_cidr_blocks = ["::/0"]
    },
    {
      description = "allow ipv4 alt http"
      port        = 8080
      protocol    = "tcp"
      cidr_blocks = ["0.0.0.0/0"]
    },
    {
      description = "allow ipv6 alt https"
      port        = 8443
      protocol    = "tcp"
      ipv6_cidr_blocks = ["::/0"]
    },
    {
      description = "allow ipv4 alt https"
      port        = 8443
      protocol    = "tcp"
      cidr_blocks = ["0.0.0.0/0"]
    },
